    ...
    <div
      ...
      <div className="flex">
        <div className="flex-shrink-0">
          {severity === 'error' && <XCircleIcon className="h-5 w-5 text-red-40" aria-hidden="true" />}
          ...
          {severity === 'success' && <CheckCircleIcon className="h-5 w-5 text-gray-400" aria-hidden="true" />}
        </div>
