        ...
        <div className="mx-auto w-full max-w-screen-xl">
          <div className="relative flex grid-cols-12 gap-3 lg:grid">
            <DesktopRefinementList>
              ...
              <DateRangePicker attribute="application_deadline" label="Application Deadline" />
            </DesktopRefinementList>
            ...
            <main className="relative col-span-10 w-full bg-gray-50">
              <div className="shadow-smooth sticky top-0 z-40 flex w-full flex-wrap items-center divide-x-2 divide-gray-100 border-b border-gray-900 border-opacity-5 bg-white md:flex-nowrap">
